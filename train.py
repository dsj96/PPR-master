...
def gen_train_data(final_model2):
    ...
    print('gen_train_data(final_model2)')
...
def gen_test_data(final_model2):
    ...
    print('gen_test_data(final_model2)')
...
for i in range(EPOCH):
    ...
    log_string = ('iter: [{:d}/{:d}], train_loss: {:0.6f}, lr: {:0.7f}').format((i + 1), EPOCH, train_loss[-1], optimizer.param_groups[0]['lr'])
