...
python3 gen_graph.py dataset/toyset/
...
./line -train dataset/toyset/net_dense.txt -output dataset/toyset/vec_2nd_wo_norm.txt -binary 0 -size 16 -order 2 -negative 5 -samples 10 -threads 15
python3 train.py dataset/toyset/
